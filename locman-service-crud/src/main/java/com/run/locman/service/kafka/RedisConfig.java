...
public class RedisConfig{
	...
	/**
	 * 
	* @Description:RedisTemplate<String,Map<String,Object>>
	* @param redisConnectionFactory
	* @return
	 */
	@Bean
	public RedisTemplate<String,Map<String,Object>>  facilityMapRedisTemplate(RedisConnectionFactory redisConnectionFactory){
		RedisTemplate<String, Map<String,Object>> redisTemplate = new RedisTemplate<>();
		initFacilityMapRedisTemplate(redisTemplate,redisConnectionFactory);
		return redisTemplate;
	...
	* @param factory
	 */
	private void initFacilityMapRedisTemplate(RedisTemplate<String, Map<String,Object>> redisTemplate, RedisConnectionFactory factory) {
		redisTemplate.setKeySerializer(new StringRedisSerializer());
		redisTemplate.setHashKeySerializer(new StringRedisSerializer());
		redisTemplate.setHashValueSerializer(new GenericJackson2JsonRedisSerializer());
		redisTemplate.setValueSerializer(new GenericJackson2JsonRedisSerializer());
